...
#define DATLINK_BACKUP_DATA_BYTES 180U
#define DATLINK_BACKUP_DATA_HEADER_LEN 10U
#define DATLINK_BACKUP_RESULT_WIRE_LEN 60U
#define DATLINK_COMMAND_ERROR_WIRE_LEN 20U
#define DATLINK_RESYNC_WIRE_LEN 16U

typedef enum {
    DATLINK_MSG_HELLO = 1,
    DATLINK_MSG_HEARTBEAT = 2,
    DATLINK_MSG_ACK = 3,
    DATLINK_MSG_RESYNC_REQUEST = 4,
    DATLINK_MSG_RESYNC_REPLY = 5,
    ...
    DATLINK_MSG_LOADER_TEST = 25,
    DATLINK_MSG_TARGET_BACKUP_START = 26,
    DATLINK_MSG_TARGET_BACKUP_DATA = 27,
    DATLINK_MSG_TARGET_BACKUP_RESULT = 28,
    DATLINK_MSG_COMMAND_ERROR = 29,
...
typedef enum {
    ...
    DATLINK_USB_LOADER_TEST = 24,
    DATLINK_USB_TARGET_BACKUP_START = 25,
    DATLINK_USB_TRANSPORT_RECOVER = 26,
    DATLINK_USB_RESPONSE = 0x80,
    DATLINK_USB_EVENT = 0x81,
} datlink_usb_type_t;

typedef enum {
    DATLINK_RESYNC_RETRANSMIT = 1,
    DATLINK_RESYNC_NEW_EPOCH = 2,
} datlink_resync_action_t;

typedef enum {
    DATLINK_RESYNC_REASON_GAP = 1,
    DATLINK_RESYNC_REASON_MANUAL = 2,
} datlink_resync_reason_t;
